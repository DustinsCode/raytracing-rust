use std::fmt;
use std::fmt::Display;
use std::ops::{Index, IndexMut, Add, AddAssign, Sub, SubAssign, Mul, Div, DivAssign, MulAssign, Range};
use rand::Rng;
...
impl Vec3 {
    ...
    pub fn reflect(self, normal: Vec3) -> Vec3 {
        self - 2.0 * self.dot_product(normal) * normal
    }

    pub fn refract(self, n: Vec3, etai_over_etat: f64) -> Vec3 {
        let cos_theta = ((-1.0) * self).dot_product(n).min(1.0);
